...
:root {
    ...
    --theme-bg: @isset($sourby_settings['pcolor']){{$sourby_settings['pcolor']}}@else #1f1d2b @endisset; ;

    /* Primary content background-color DEFAULT #0000000d */
    --theme-primary-bg: @isset($sourby_settings['scolor']){{$sourby_settings['scolor']}}@else #0000000d @endisset; ;

    /* Secondary content background-color DEFAULT #0000001a */
    --theme-secondary-bg: @isset($sourby_settings['tcolor']){{$sourby_settings['tcolor']}}@else #0000001a @endisset;;

    /* Background of the Buttons in login page DEFAULT #0045ff */
    --theme-button-bg: @isset($sourby_settings['buttoncolor']){{$sourby_settings['buttoncolor']}}@else #0045ff @endisset;;

    /* side-menu text color DEFAULT #808191 */
    --body-color: @isset($sourby_settings['textcolor']){{$sourby_settings['textcolor']}}@else #808191 @endisset;;
