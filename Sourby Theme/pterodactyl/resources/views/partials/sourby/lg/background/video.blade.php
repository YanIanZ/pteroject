@section('sourby::lg.background.video')
...
<div class="fullscreen-video-background">
		...
		<div id="_youtube-iframe-wrapper">
			<div id="_youtube-iframe" data-youtubeurl="@isset($sourby_settings['login-bg-youtube']){{$sourby_settings['login-bg-youtube']}}@else edYCtaNueQY @endisset"></div>
		</div>
	</div>
	<style>
