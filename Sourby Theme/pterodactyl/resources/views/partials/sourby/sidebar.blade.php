<div class="container sourby-sidebar">
    <div class="sidebar">
        <span class="logo">
        ...
        <a class="logo-expand" href="/" style="display: flex; align-items: center; justify-content: center;">
            ...
            <img onclick="window.location.href='/auth/login'" src="@isset($sourby_settings['brand-logo']){{ $sourby_settings['brand-logo'] }}@else /assets/svgs/pterodactyl.svg @endisset" style="width: 42px; padding: 4px;"> @endif @endisset
        ...
        <div class="side-wrapper">
            ...
            <div class="side-menu">
                <a class="sidebar-link discover is-active" href="/">
                    ...
                    </svg> {{ config('sourby.servers', 'Servers') }}
                </a>
            </div>
        </div>
    </div>
