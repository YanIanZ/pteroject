...
export default ({ server, className }: { server: Server; className?: string }) => {
    ...
    const diskLimit = server.limits.disk !== 0 ? bytesToString(server.limits.disk * 1024 * 1024) : 'Unlimited';
    const memoryLimit = server.limits.memory !== 0 ? bytesToString(server.limits.memory * 1024 * 1024) : 'Unlimited';
